...
export const products: Product[] = [
  ...
  {
    id: "13",
    name: "Butter Pendant – Iridescent Teal",
    price: 299,
    image: "/images/products/butter-pendant-1.jpg",
    images: ["/images/products/butter-pendant-1.jpg"],
    tag: "New",
    category: "Pendants",
    description:
      "Handcrafted glass butterfly pendant in iridescent teal and green tones on a woven black cord. Each wing catches the light differently.",
    colors: ["Blue", "Turquoise"],
    inStock: true,
  },
  {
    id: "14",
    name: "Butter Pendant – Rose Pink",
    price: 299,
    image: "/images/products/butter-pendant-2.jpg",
    images: ["/images/products/butter-pendant-2.jpg"],
    tag: "New",
    category: "Pendants",
    description:
      "Stunning pink-to-magenta gradient glass butterfly pendant on a braided black cord. Bold and feminine.",
    colors: ["Pink"],
    inStock: true,
  },
  {
    id: "15",
    name: "Butter Pendant – Ocean Turquoise",
    price: 299,
    image: "/images/products/butter-pendant-3.jpg",
    images: ["/images/products/butter-pendant-3.jpg"],
    category: "Pendants",
    description:
      "Vivid turquoise glass butterfly pendant with delicate black speckles. Evokes tropical ocean waters.",
    colors: ["Turquoise", "Blue"],
    inStock: true,
  },
  {
    id: "16",
    name: "Butter Pendant – Midnight Blue",
    price: 299,
    image: "/images/products/butter-pendant-4.jpg",
    images: ["/images/products/butter-pendant-4.jpg"],
    category: "Pendants",
    description:
      "Deep midnight blue and golden glass butterfly pendant on a sleek black cord. Mysterious and elegant.",
    colors: ["Blue"],
    inStock: true,
  },
  {
    id: "17",
    name: "Butter Pendant – Amber Glow",
    price: 299,
    image: "/images/products/butter-pendant-5.jpg",
    images: ["/images/products/butter-pendant-5.jpg"],
    tag: "New",
    category: "Pendants",
    description:
      "Crystal-clear glass butterfly pendant with warm amber and red edges. Catches sunlight beautifully.",
    colors: ["Clear", "Red"],
    inStock: true,
  },
]
